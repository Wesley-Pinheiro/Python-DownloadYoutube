...
def downloadPlaylist(url_playlist):
    ...
    for video in pl.videos:        
        video.streams.filter(progressive = True, file_extension = "mp4").order_by('resolution').get_highest_resolution().download("/home/pinheirocfc/Downloads/")
        try:
            #Titulo do video
            title = video.title
...
downloadURL("https://www.youtube.com/watch?v=DJVPIlDT2zw&list=RDMM&index=2") #chamar funcao para download unico
